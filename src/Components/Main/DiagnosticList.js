...
const DiagnosticList = () => {
    ...
    return ( 
        <div className="py-5 px-2 flex flex-col items-start justify-center gap-y-5 bg-white rounded-lg shadow  ">
            ...
            <div className="flex flex-col items-start justify-center gap-y-4 ">
                ...
                <div className="flex flex-col w-full gap-y-3 overflow-y-scroll h-[30vh] ">
                    {profile.diagnostic_list.map((list,index)=>(
                        <div className="grid border-b grid-cols-5 gap-x-[50px] p-5 bg-[pink] hover:bg-[#F6F7F9]  items-start justify-start w-full " key={index}>
